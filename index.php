...
<!--            ---------------------------------------------------------------------------------------->
            <div class="chal">
                <div class="scene">
                    <div class="carousel">
                        <div class="carousel__cell"><h1 class="dual-heading">BUSSINESS <span>WEBSITE</span></h1></div>
                        <div class="carousel__cell"><h1 class="dual-heading">BUSSINESS <span>WEBSITE</span></h1></div>
                        <div class="carousel__cell"><h1 class="dual-heading">BUSSINESS <span>WEBSITE</span></h1></div>
                        <div class="carousel__cell"><h1 class="dual-heading">BUSSINESS <span>WEBSITE</span></h1></div>
                    </div>
                ...
                <div class="carousel-options">
                    <p>
                        <label>
                            Cells
                            <input class="cells-range" type="range" min="4" max="15" value="1" />
                        </label>
                    </p>
                    <p>
            ...
            <style>
                .chal { box-sizing: border-box; text-align: center;}
